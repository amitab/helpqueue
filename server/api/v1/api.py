...
api.add_resource(api_user.UserDashboard, '/user/dashboard')
api.add_resource(api_user.UserDashboardA, '/user/dashboardA')
api.add_resource(api_user.UserDashboardB, '/user/dashboardB')
